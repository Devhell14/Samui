...
router.post('/create-pr-h', (req, res) => {
    ...
    const docIsPO = req.body.doc_is_po;
    ...
    INSERT INTO PR_H (
        ...
        Doc_Type, Doc_For, Doc_Is_PO, Ref_DocID, Ref_Doc, 
        Ref_DocDate, Ref_ProjectID, Ref_ProjectNo, Comp_Id, 
        Transport_Type, Doc_Remark1, Doc_Remark2, AP_ID, 
        ...
        @docType, @docFor, @docIsPO, @refDocID, @refDoc, 
        @refDocDate, @refProjectID, @refProjectNo, @compId, 
        @transportType, @docRemark1, @docRemark2, @apID, 
...
router.post('/update-pr-h', (req, res) => {
    if (!checkApiKey(req, res)) return;
    ...
    const params = [
        ...
        { name: 'docIsPO', value: req.body.doc_is_po },
    ...
    UPDATE PR_H SET
        ...
        Doc_Is_PO = @docIsPO, Ref_DocID = @refDocID, Ref_Doc = @refDoc, 
...
router.post('/cancel-pr-h', (req, res) => {
    if (!checkApiKey(req, res)) return;
