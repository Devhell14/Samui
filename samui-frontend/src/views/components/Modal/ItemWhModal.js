...
const ItemWhModal = ({ showItemModal, handleItemClose, itemDataList, onRowSelectItem }) => {
    // สถานะการค้นหา
                ...
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">รายชื่อสินค้าในคลัง</h5>
                                ...
                                <table className="table table-striped table-hover">
                                    <thead className="thead-dark">
                                        <tr>
                                            ...
                                            <th className="text-center" style={{ width: '529px' }}>สินค้าคงเหลือ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {filteredItemDataList && filteredItemDataList.length > 0 ? (
                                            filteredItemDataList.map((item, index) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="text-left">{item.Item_Onhand}</td>
                                                </tr>
                                            ))
                                        ) : (
                                            <tr>
