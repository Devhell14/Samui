...
function Form({ callInitialize, mode, name, maxDocNo }) {
    ...
    const getModelByNo = async (arDataList) => {
        try {
            ...
            const findMaster = await getDataWithComp('DEPOS_H', ``);
            ...
            // ค้นหาข้อมูล VIEW
            const findViewMaster = await getDataWithComp('API_0501_DEPOS_H', '');
    ...
    const handleSubmit = async () => {
        try {
            ...
            const findMaxDocNo = await getDataWithComp('DEPOS_H', 'ORDER BY Doc_No DESC');
        ...
        <>
            ...
            <div className="row mt-2">
                ...
                <FormAction
                    ...
                    mode={mode}
                    docStatus={formMasterList.docStatus}
