        ...
        if (startDate && endDate) {
            ...
            filteredByDate = dataMasterList.filter(item => {
                const itemDate = type === 'documentDate'
                    ? moment(item.Rec_Date, "YYYY-MM-DD")
                    : type === 'dueDate'
                        ? moment(item.Rec_DueDate, "YYYY-MM-DD")
                        : null;
                        ...
                        <div className="col-1 d-flex justify-content-between">
                            <div className="radio-inline">
                                <input
                                    ...
                                    type="radio"
                                    checked={sortField === 'Rec_No'}
                                    onChange={() => setSortField('Rec_No')}
                                />
                        ...
                        <div className="col-1 d-flex justify-content-between">
                            <div className="radio-inline">
                                <input
                                    className="form-check-input"
                                    type="radio"
                                    checked={sortField === 'Rec_Date'}
                                    onChange={() => setSortField('Rec_Date')}
                                />
                        ...
                        <div className="col-1 d-flex justify-content-between">
                            <div className="radio-inline">
                                <input
                                    className="form-check-input"
                                    type="radio"
                                    checked={sortField === 'Rec_DueDate'}
                                    onChange={() => setSortField('Rec_DueDate')}
                                />
            ...
            <div className="row">
                ...
                <DataTable
                    ...
                    fieldMappings={{
                        ...
                        statusPaidName: 'DocStatusPaid_Name',
                        statusPaidColour: 'DocStatusPaid_Colour',
                        date: 'Rec_Date',
                        apCode: 'AP_Code',
                        apName: 'AP_Name',
                        dueDate: 'Rec_DueDate',
