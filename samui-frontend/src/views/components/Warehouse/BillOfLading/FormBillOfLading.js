...
const FormBillOfLading = ({ callInitialize, mode, name, whDocNo }) => {
  ...
  return <>
    <Breadcrumbs page={whDocNo} items={[
      ...
      { name: "ใบเบิกสินค้า", url: '/billof-lading' },
...
export default FormBillOfLading;
